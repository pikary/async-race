...
import { Car, EngineStatuses, Race, RaceStatuses } from './types';
...
const CarsSlice = createSlice({
    ...
    reducers: {
        ...
        selectCar: (state, action: PayloadAction<Car>) => {
            if (
                state.selectedCar &&
                state.selectedCar.id === action.payload.id
            ) {
        ...
        updateCarProgress: (
            ...
            const car = state.race?.cars.find(
        ...
        builder
            ...
            .addCase(driveCarAsync.rejected, (state, action) => {
                ...
                if (isAbortError(action.payload)) {
                    ...
                    if (carIndex !== -1) {
                        state.data![carIndex].engineStatus =
                            EngineStatuses.STOPPED;
                        state.race!.cars![carIndex].engineStatus =
                            EngineStatuses.STOPPED;
                    }
